...
function ChequeSelecionado() {
    // Declaração de Variáveis
    var TipoPagamento = document.getElementById("FormaPagamento").value;
    var inserir_elemento = document.getElementById("returmMetodoPagamento");
